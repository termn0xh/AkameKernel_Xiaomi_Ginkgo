#!/bin/bash
#
# Compile script for CyberEdge,AkameKernel Kernel.
...
export KBUILD_BUILD_HOST=Akame@CE
...
if [[ $1 = "-b" || $1 = "--build" ]]; then
	...
	elif ! git clone -q https://github.com/termn0xh/Anykernel -b ginkgo-udc ; then
